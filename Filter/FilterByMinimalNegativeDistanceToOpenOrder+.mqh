...
class FilterByMinimalNegativeDistanceToOpenOrder : public Filter
{
   protected:
      string m_instrument;
      int m_magic;
   ...
   public:
      FilterByMinimalNegativeDistanceToOpenOrder(const string instrument, const int magic, const int type, const long minimalDistance)
      {
