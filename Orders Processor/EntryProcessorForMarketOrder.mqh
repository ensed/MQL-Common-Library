...
class EntryProcessorForMarketOrder : public EntryProcessor
{     
   public:
      EntryProcessorForMarketOrder
      (
   ...
   protected:
      ...
      {    
         ...
         {        
            ...
            OrderOpener opener(m_instrument, m_type, m_magic, m_volumeCalculator.Get(), m_comment, m_slippage);
